...
// New Event Listener for Mouse Click
addEventListener("click", (e) => {
  window.location.href = "C:/Users/Sahil Dherange/Desktop/dti/dti final/product-page-text-bg-animation (2)/product-page-text-bg-animation/product-page-text-bg-animation/dist/index.html";
});
